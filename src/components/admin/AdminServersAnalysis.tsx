...
import { ServerType, CategoryType, ChannelType } from "@/types";
...
const AdminServerAnalysis = (props: PropType) => {
  const { servers } = props;
  ...
  return (
    <div className="my-10 mx-10 p-6 rounded-md bg-secondary-white dark:bg-primary-gray">
      <h1 className="text-[20px] font-bold mb-5">Servers Analysis</h1>
      <Table>
        <TableHeader>
            ...
            >
              ...
              <TableCell>
                <div className="flex items-center gap-3">
                  <GrGroup size={30} />
                  <p>{server?.totalMembers}</p>
                </div>
              </TableCell>
              <TableCell>
                <div className="flex items-center gap-3">
                  <MdCategory size={30} />
                  <p>{server?.totalCategories}</p>
                </div>
              </TableCell>
              <TableCell>
                <div className="flex items-center gap-3">
                  <PiTelevisionBold size={30} />
                  <p>{server?.totalChannels}</p>
                </div>
              </TableCell>
            </TableRow>
          ))}
...
export default AdminServerAnalysis;
